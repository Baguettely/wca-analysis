...
CREATE TEMPORARY TABLE t1 AS
  SELECT 
    ...
    r.best, 
    r.average, 
    r.regionalSingleRecord AS stored_single, 
    r.regionalAverageRecord AS stored_average, 
    ons.old_NR_single, 
    ona.old_NR_average
  FROM 
    Results r
...
CREATE TEMPORARY TABLE t2 AS
  ...
  WHERE 
    ...
    OR t1.stored_single IS NOT NULL
    OR t1.stored_average IS NOT NULL;
